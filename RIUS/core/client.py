        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    Aio8.add_event_handler(func, events.MessageEdited(**kwargs))
                Aio8.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Aio8.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Aio8.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
