...
async def yt_search(RIUS):
    try:
        RIUS = urllib.parse.quote(RIUS)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={RIUS}"
        )
...
"""
async def yt_data(RIUS):
    params = {"format": "json", "url": RIUS}
