...
RIUS = ['yes']
its_Reham = False
@Aio8.on(admin_cmd(pattern="(تجميع مليار|تجميع المليار)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username)
        await Aio8.send_message('@EEObot', '/start')
        await asyncio.sleep(1)
        msg0 = await Aio8.get_messages('@EEObot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(1)
        msg1 = await Aio8.get_messages('@EEObot', limit=1)
        ...
        for i in range(100):
            ...
            list = await Aio8(GetHistoryRequest(peer=channel_entity, limit=1, offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي، قم بتجميع النقاط بطريقة مختلفة') != -1:
                await Aio8.send_message(event.chat_id, "**لا توجد قنوات للبوت.**")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                    await Aio8(JoinChannelRequest(url))
                except:
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@EEObot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
                await Aio8.send_message(event.chat_id, "**خطأ، قد يكون تم حظرك.**")
                break
        await Aio8.send_message(event.chat_id, "**تم الانتهاء من التجميع!**")
    else:
        await event.edit("يجب الدفع لاستخدام هذا الأمر!")



@Aio8.on(admin_cmd(pattern="(تجميع الجوكر|تجميع جوكر)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username2)
        await Aio8.send_message('@A_MAN9300BOT', '/start')
        await asyncio.sleep(2)
        msg0 = await Aio8.get_messages('@A_MAN9300BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await Aio8.get_messages('@A_MAN9300BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            list = await Aio8(GetHistoryRequest(peer=channel_entity, limit=1,
                                                   offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await Aio8.send_message(event.chat_id, f"**لاتوجد قنوات للبوت**")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@A_MAN9300BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except Exception as er:
                await Aio8.send_message(event.chat_id, f"**خطأ , ممكن تبندت**\n{er}")
        await Aio8.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")

    else:
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
@Aio8.on(admin_cmd(pattern="(تجميع العقاب|تجميع عقاب)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username3)
        await Aio8.send_message('@MARKTEBOT', '/start')
        await asyncio.sleep(3)
        msg0 = await Aio8.get_messages('@MARKTEBOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(3)
        msg1 = await Aio8.get_messages('@MARKTEBOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@MARKTEBOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
        ...
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
@Aio8.on(admin_cmd(pattern="(تجميع المليون|تجميع مليون)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username4)
        await Aio8.send_message('@qweqwe1919bot', '/start')
        await asyncio.sleep(2)
        msg0 = await Aio8.get_messages('@qweqwe1919bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await Aio8.get_messages('@qweqwe1919bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@qweqwe1919bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
        ...
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
################################
@Aio8.on(admin_cmd(pattern="(تجميع عرب|تجميع العرب)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username5)
        await Aio8.send_message('@xnsex21bot', '/start')
        await asyncio.sleep(5)
        msg0 = await Aio8.get_messages('@xnsex21bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await Aio8.get_messages('@xnsex21bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@xnsex21bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
################################
@Aio8.ar_cmd(pattern="راتب وعد(?:\s|$)([\s\S]*)")
...
async def send_reham(event):
    ...
    if is_active_status == "True":
        ...
        await send_reham(event)  
@Aio8.ar_cmd(pattern="ايقاف راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        delgvar("is_active")
        ...
        await event.edit("**هذا الأمر يمكن استخدامه فقط في المجموعات!**")
@Aio8.ar_cmd(pattern="بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        ...
        if is_rio_status != "True":
            addgvar("is_rio", "True")
            await send_Rio(event)
        else:
            await event.edit("**راتب وعد قيد التشغيل بالفعل!**")
    else:
        await event.edit("**هذا الأمر يمكن استخدامه فقط في المجموعات!**")
async def send_Rio(event):
    is_rio_status = gvarstatus("is_rio")
    if is_rio_status == "True":
        await event.respond('بخشيش')
        await asyncio.sleep(660)
        await send_Rio(event)  
@Aio8.ar_cmd(pattern="ايقاف بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
        delgvar("is_rio")
        ...
        await event.edit("**᯽︙ هذا الأمر يمكن استخدامه فقط في المجموعات!**")
@Aio8.ar_cmd(pattern="استثمار وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
...
async def Reham_english(event, message):
    ...
    if its_hussein_status == "True":
        ...
        if not message.isnumeric():
            await event.respond("**تنبيه: يجب أن يحتوي رقم الاستثمار على أرقام فقط!**")
@Aio8.ar_cmd(pattern="ايقاف استثمار وعد(?:\s|$)([\s\S]*)")
...
@Aio8.ar_cmd(pattern="سرقة وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    if event.is_group:
...
@Aio8.ar_cmd(pattern="ايقاف سرقة وعد(?:\s|$)([\s\S]*)")
async def Reham(event):
    if event.is_group:
        its_reda_status = gvarstatus("its_reda")
        if its_reda_status == "True":
...
@Aio8.ar_cmd(pattern="استثمار بوت وعد")
async def Rio_money_w3d(event):
    global its_Reham
    if event.is_group:
...
@Aio8.ar_cmd(pattern="تعطيل استثمار وعد")
...
@Aio8.on(NewMessage(incoming=True))
async def handle_new_message(event):
    if event.reply_to and event.sender_id == 1421907917:
        reply_msg = await event.get_reply_message()
        owner_id = reply_msg.from_id.user_id
        if owner_id == Aio8.uid and 'فلوسك صارت' in event.message.message and 'استثمار' in event.message.message:
            amount_t = event.message.message.split('فلوسك صارت')[-1].split('ريال')[0].strip()
            amount = re.sub(r'\D', '', amount_t)
            


@Aio8.on(admin_cmd(pattern="(تجميع السلطان|تجميع سلطان)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username6)
        await Aio8.send_message('@YY8bot', '/start')
        await asyncio.sleep(1)
        msg0 = await Aio8.get_messages('@YY8bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(1)
        msg1 = await Aio8.get_messages('@YY8bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@YY8bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
        ...
        await event.edit("يجب الدفع لاستخدام هذا الأمر!")
@Aio8.on(admin_cmd(pattern="(تجميع اسياسيل|تجميع اسيا)"))
async def _(event):
    if RIUS[0] == "yes":
        ...
        channel_entity = await Aio8.get_entity(bot_username7)
        await Aio8.send_message('@cn2bot', '/start')
        await asyncio.sleep(1)
        msg0 = await Aio8.get_messages('@cn2bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(1)
        msg1 = await Aio8.get_messages('@cn2bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages('@cn2bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await Aio8.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
        ...
        await event.edit("يجب الدفع لاستخدام هذا الأمر!")
@Aio8.on(events.NewMessage(incoming=True))
async def Hussein(event):
    if event.message.message.startswith("تجميع المليار") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username)
        await Aio8.send_message(bot_username, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await Aio8.send_message(event.chat_id, f"تم الانتهاء من التجميع ")
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def Hussein(event):
    if event.message.message.startswith("تجميع الجوكر") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username2)
        await Aio8.send_message(bot_username2, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username2, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username2, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username2, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع العقاب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username3)
        await Aio8.send_message(bot_username3, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username3, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username3, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username3, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليون") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username4)
        await Aio8.send_message(bot_username4, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username4, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username4, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username4, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع العرب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username5)
        await Aio8.send_message(bot_username5, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username5, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username5, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username5, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع السلطان") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username6)
        await Aio8.send_message(bot_username6, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username6, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username6, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username6, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع اسيا") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await Aio8.get_entity(bot_username7)
        await Aio8.send_message(bot_username7, '/start')
        await asyncio.sleep(4)
        msg0 = await Aio8.get_messages(bot_username7, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await Aio8.get_messages(bot_username7, limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await Aio8(ImportChatInviteRequest(bott))
                msg2 = await Aio8.get_messages(bot_username7, limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await event.edit(f"تم الانضمام في {chs} قناة")
            except:
