...
from . import Aio8, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m RIUS`",
        "**State changed from starting to up**",
        "__INFO:RIUS:Logged in as 557667062__",
        "__INFO:RIUS:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
