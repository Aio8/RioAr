...
@Aio8.ar_cmd(pattern=f"كتم(?:\s|$)([\s\S]*)")
...
@Aio8.ar_cmd(pattern=f"(الغاء الكتم|الغاء كتم)(?:\s|$)([\s\S]*)")
...
async def handle_message(event):
    ...
    if private_mode.get(chat_id, False) and sender_id != (await Aio8.get_me()).id:
        try:
            await event.delete()
