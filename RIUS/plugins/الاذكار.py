...
@Aio8.on(events.NewMessage(pattern=r"^.اختصر (.+) (.+)"))
...
@Aio8.on(events.NewMessage(pattern=r"^\.(.+)"))
...
@Aio8.on(events.NewMessage(pattern=r"^.قائمه الاختصار|قائمة الاختصار"))
...
@Aio8.on(events.NewMessage(pattern=r"^\.امسح (.+)$"))
