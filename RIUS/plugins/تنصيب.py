    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == bot.uid:
            ...
            if ROZ_PIC and ROZ_PIC.endswith((".jpg", ".png", "gif", "mp4")):
                ...
                result = builder.document(ROZ_PIC,title="RIUS",text=ROZ,buttons=buttons,link_preview=False)
            else:
                result = builder.article(title="RIUS",text=ROZ,buttons=buttons,link_preview=False)
