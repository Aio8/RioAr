        ...
        try:
            if reply.sticker:
                ...
                if mode == "امن":
                    ...
                    await Aio8.send_message(speedrunminecraft, modified_message)
                else:
                    await Aio8.send_message(speedrunminecraft, rioishere[speedrunminecraft].message)
...
Aio8.loop.create_task(restore_tasks())