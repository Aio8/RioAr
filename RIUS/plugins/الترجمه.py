...
import requests
import json
from RIUS.helpers.functions.functions import translate
...
@Aio8.ar_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
...
@Aio8.ar_cmd(pattern="لغة الترجمة")
