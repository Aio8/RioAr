...
@Aio8.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular RIUS",
    },
)
...
@Aio8.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular RIUS",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@Aio8.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna RIUS is One of the Popular RIUS",
    },
)
async def nekobot(cat):
...
@Aio8.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; RIUS is One of the Popular RIUS",
    },
)
async def nekobot(cat):
