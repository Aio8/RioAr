...
import randomstuff
import RIUS
from RIUS import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
print(RIUS.__copyright__)
print("Licensed under the terms of the " + RIUS.__license__)
...
try:
    ...
    Aio8.loop.run_until_complete(setup_bot())
...
try:
    ...
    Aio8.loop.run_until_complete(mybot())
...
async def externalrepo():
    if Config.VCMODE:
        await install_externalrepo("https://github.com/Aio8/music", "main", "music")
